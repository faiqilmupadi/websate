...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pembimbingakademik', function (Blueprint $table) {
            $table->string('nidn_pembimbingakademik')->primary(); // NIDN pembimbing akademik sebagai primary key
            $table->string('nama_pembimbingakademik'); // Nama pembimbing akademik
