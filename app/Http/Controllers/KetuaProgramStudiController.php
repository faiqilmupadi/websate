...
class KetuaProgramStudiController extends Controller
{
    ...
    public function show($kode_mk)
    {
        ...
        $dosenpengampu = DosenPengampu::find($nidn_dosenpengampu);// Cari mata kuliah berdasarkan ID
        return view('memilihmatakuliah', compact('mata_kuliah')); // Kirim data ke view
    }
